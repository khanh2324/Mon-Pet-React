const images =  {
    ...
    headerLogo: require('~/assets/images/logo/header_logo.png'),
    uploadSlider: require('~/assets/images/slider/uploadslider.jpg'),
    introduceHome: require('~/assets/images/introduce/shaking-hands8.jpg'),
    penCommit:  require('~/assets/images/logo/pen.png'),
    boxCommit:  require('~/assets/images/logo/layout-box.png'),
